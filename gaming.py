...
# Background
background = pygame.image.load('spacebag.png')
...
# Ready = You can't see the bullet in action
...
def fire_bullet(x, y):
    global bullet_state
    bullet_state = "fire"
    screen.blit(bulletImg, (x + 16, y + 10))  # Center of the space ship
...
while running:
    ...
    screen.fill((0, 0, 0))  # RGB = red,green blue #www.rapidtables.com (for more colours)
    ...
    # Checking boundaries for spaceship so that it doesn't go out of border
    ...
    pygame.display.update()  # compulsory
